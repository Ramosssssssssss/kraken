      ...
      <div className="flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 text-white transition-all hover:from-blue-700 hover:to-purple-700 shadow-lg shadow-blue-500/20"
              aria-label="Add new"
            >
