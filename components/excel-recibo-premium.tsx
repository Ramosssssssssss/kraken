...
export default function ExcelReciboPremium({ excelData }: ExcelReciboProps) {
  ...
  const processScan = (raw: string) => {
    ...
    console.log("[v0] Excel scan detected:", code)

    const idx = detalles.findIndex((d) => d.CLAVE.toUpperCase() === code)

    console.log("[v0] Found index:", idx)
    ...
    if (idx >= 0) {
      setDetalles((prev) => {
        ...
        console.log("[v0] Updated item:", next[idx])
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-semibold text-slate-900">Recepción Excel</h1>
                  <p className="text-md text-slate-500">Gestión de Entradas desde Excel</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="glass rounded-2xl p-6 mb-6 border border-white/20">
                ...
                <p className="text-slate-600">
                  Proveedor: {caratula.PROVEEDOR} • Almacén: {caratula.ALMACEN}
                </p>
              </div>
            </div>
          </div>
